<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 ">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-3 bg-primary rounded-2 shadow">
        <div class="flex justify-between h-16">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button 
                            ...
                            transition ease-in-out duration-150 shadow">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button 
                    ...
                    0 focus:outline-none focus:bg-gray-100  
                    focus:text-gray-500 transition duration-150 ease-in-out bg-light shadow">
